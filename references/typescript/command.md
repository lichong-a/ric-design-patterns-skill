# TypeScript · 命令（Command）

[← TypeScript 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/typescript/command/main.ts)
...
字面量联合类型表达命令阶段，运行时分支仍负责拒绝错误次序。包含接收者引用的内存命令不能直接 JSON 序列化用于任务队列。
...
```sh
cd examples/typescript/command
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`6a81e97c7a8f31b219ce20137f2635786843b2f1a5bcf4248f3d340843026836`。
