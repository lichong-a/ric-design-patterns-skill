# TypeScript · 责任链（Chain of Responsibility）

[← TypeScript 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/typescript/chain-of-responsibility/main.ts)
...
函数谓词组成短路校验链变体。异步中间件应统一 Promise 返回值并约束 next 调用次数，不把这里的同步 boolean 链直接当作异步实现。
...
```sh
cd examples/typescript/chain-of-responsibility
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`b01235c0dcc03c2f378ea19f7c54c8c61f412555570ea654d2a07baa6db4e95c`。
