# TypeScript · 观察者（Observer）

[← TypeScript 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/typescript/observer/main.ts)
...
使用 Map token 与快照数组避免通知中修改容器破坏遍历。同步异常会打断通知；接收 async 回调不意味着发布者会等待其完成。
...
```sh
cd examples/typescript/observer
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`ec18ea7520f8afa3cbf8c90e231084fe6d249c98cc20c95d5cca950b14482f9c`。
