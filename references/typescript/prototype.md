# TypeScript · 原型（Prototype）

[← TypeScript 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/typescript/prototype/main.ts)
...
按已知结构复制两层数组，保留 Document 方法。不要用 JSON 序列化当作任意对象克隆，也不要把原型链与 GoF Prototype 混为一谈。
...
```sh
cd examples/typescript/prototype
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`4a21cc22d2cd10c5a1c38acf12d924ca7016c7ca5fe8f90cdf99d53d5f3ed092`。
