...
[← TypeScript 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/typescript/proxy/main.ts)
...
显式代理类比 JavaScript Proxy 元编程更容易展示主体契约。同步演示没有异步竞态处理，真正加载需要失败重试/取消策略。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`5c955283390fb982dfb7b3cf454c28342fb37356bcf9400db6b1528e740d1d0b`。
