# TypeScript · 中介者（Mediator）

[← TypeScript 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/typescript/mediator/main.ts)
...
箭头函数保留 Dialog 的 this，控件不直接引用彼此。DOM 或事件总线集成时应提供 dispose，避免长生命周期发布者保留整个对话框。
...
```sh
cd examples/typescript/mediator
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`50ab469887292c1029796d13b85afefa14c8a1d33c90582b29bdf4dd67214d33`。
