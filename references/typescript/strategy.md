# TypeScript · 策略（Strategy）

[← TypeScript 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/typescript/strategy/main.ts)
...
函数类型足以表达单方法策略。执行边界保留运行时有限数校验；真实金额不应因这里使用 number 就忽略精度与单位约束。
...
```sh
cd examples/typescript/strategy
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`4babb90c143bc97e3d8f28d7c3ca812aca0a7f349cc87bfae2b0f4802c754c80`。
...
- [参考站语言示例抽样](https://refactoringguru.cn/design-patterns/strategy/typescript/example)
