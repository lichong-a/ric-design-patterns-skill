# TypeScript · 生成器（建造者）（Builder）

[← TypeScript 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/typescript/builder/main.ts)
...
现代单产品构建器；readonly 提供静态约束，Object.freeze 分别冻结产品和复制后的数组。freeze 默认浅层，本例成员字符串不可变。
...
```sh
cd examples/typescript/builder
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`c670e2b238783a2318e97722bc47458e861a1073ea436075d3775581702b3759`。
