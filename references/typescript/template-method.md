# TypeScript · 模板方法（Template Method）

[← TypeScript 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/typescript/template-method/main.ts)
...
抽象类固定算法骨架并开放 parse；TypeScript 没有 final 方法，禁止扩展者覆写 run 是 API 约定，需要审核或组合设计辅助。
...
```sh
cd examples/typescript/template-method
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`d064cd0348983d1dab6344e25a421073af2f20252ebe897aa0e44f316aba77e8`。
