# TypeScript · 外观（门面）（Facade）

[← TypeScript 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/typescript/facade/main.ts)
...
入口执行运行时整数校验，不把 number 注解误当作输入验证。本例没有异步支付，外观不赋予多个操作事务性。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`0fa763035c6df3a925b5ca31d5dfd69682d2e457be335ae3a9992943958e062d`。
