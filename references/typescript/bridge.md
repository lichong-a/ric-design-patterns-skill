# TypeScript · 桥接（Bridge）

[← TypeScript 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/typescript/bridge/main.ts)
...
消息形式与 Channel 分开扩展；本例同步返回字符串。实际异步渠道应统一为 Promise 契约，不能混合假定同步与异步完成。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`c1c6a3d12040234612d65a3873c2808f27d68ec537e47b5501c5ddaaa62dac66`。
