...
[← C++ 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/cpp/template-method/main.cpp)
...
Non-Virtual Interface 惯例：公开 run 非虚，变化点 parse 受保护且虚。示例只定义 ASCII 大写与空格裁剪，不暗示实现了 Unicode 文本规范化。
...
```sh
cd examples/cpp/template-method
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`b325ea12d26b783f06f02c4c4009d705ff80c33796c18e3a5a9e4b3d0a107378`。
