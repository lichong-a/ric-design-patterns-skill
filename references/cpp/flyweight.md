...
[← C++ 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/cpp/flyweight/main.cpp)
...
shared_ptr<const Style> 表达共享且只读的内在状态；坐标留在 Glyph。map 池是单线程示例，无淘汰，不应直接作为无界全局缓存。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`c40c1fe821814238647de4755dcdd1af48967bc28752be265dfe67bcdf78646b`。
