...
[← C++ 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/cpp/visitor/main.cpp)
...
accept 的虚分派加类型明确的 visit 构成双分派；新增节点要求更新所有 visitor。节点集合封闭时也应比较 std::variant/std::visit，避免惯性建类。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`10cc2c8624ab1a5c7a85046bb840c236eed1469b8c9cf340b821aad28695a766`。
...
- [参考站语言示例抽样](https://refactoringguru.cn/design-patterns/visitor/cpp/example)
