...
[← C++ 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/cpp/memento/main.cpp)
...
friend 让源发器访问快照私有数据；共享只读身份令牌避免简单地址复用导致快照错配。源发器禁复制，定义身份而非意外共享。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`9ed6072fa0406a863e3c0352192d5ff78e369fecca94d27970dbf0e1243e7812`。
