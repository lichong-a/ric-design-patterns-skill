...
[← C++ 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/cpp/abstract-factory/main.cpp)
...
客户端只持工厂 const 引用；两种独立产品接口组成产品族。这里工厂保证族的一致性，接口不阻止外部故意混用产品。
...
```sh
cd examples/cpp/abstract-factory
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`bc96a94208477239edc45a538e51044f8324fb557e0e1051c1d05de2a11d488b`。
