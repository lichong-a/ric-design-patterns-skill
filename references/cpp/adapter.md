...
[← C++ 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/cpp/adapter/main.cpp)
...
对象适配器按值包含旧传感器，避免不必要的多重继承和悬垂引用；显式使用浮点除法进行单位转换。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`db87ddbbe9d6a908be4152809248000941cab2a88c3075f8a0f3051a5a6be516`。
