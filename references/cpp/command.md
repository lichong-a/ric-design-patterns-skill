...
[← C++ 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/cpp/command/main.cpp)
...
命令借用接收者引用，接收者必须比命令活得更久。保存前值的撤销仅适用于无交错写入的示例；并发需版本校验、事务或补偿策略。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`58211eeb7dcd041171d5e02d1ddd55b3e7ec1540b4561e2cdbc675f85a06104b`。
