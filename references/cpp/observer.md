...
[← C++ 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/cpp/observer/main.cpp)
...
每轮复制回调表，订阅变动在下一轮生效；捕获引用需要保证被捕获对象生命周期。同步 fail-fast；不提供线程安全、持久消息或异步背压。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`e8bdc837de144c5b90f5c1c8d799135422e73fea98249de12297258a1dba90a9`。
