...
[← C++ 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/cpp/proxy/main.cpp)
...
unique_ptr 支持按需创建且自动销毁真实主体；read 会修改代理状态，未加互斥，不能据此宣称并发只初始化一次。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`0df45b46fab9adadc2909ba91046e6e0a4e2f52bc6c9f19ec6f562f1a181733a`。
