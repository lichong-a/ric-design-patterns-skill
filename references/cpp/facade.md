...
[← C++ 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/cpp/facade/main.cpp)
...
小型子系统按值拥有，没有引入全局 Service Locator。失败异常向上传播；字符串模拟不代表具备真实事务或库存并发控制。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`a8140e281ff2fe81ca30c1101ee99ac7a51591395ada3d654b640ca28de7488a`。
