...
[← C++ 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/cpp/iterator/main.cpp)
...
直接实现 begin/end 与标准迭代器惯例，不必再造 Java 风格接口。迭代器借用容器存储，Bag 析构后不能继续访问。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`57fc9abe43987fef335d7b497d1e4fa5172c74f8af9bfc771fe4647b2f7a2523`。
