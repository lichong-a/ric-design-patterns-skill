...
[← C++ 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/cpp/singleton/main.cpp)
...
函数内静态对象在 C++11 起具有线程安全初始化；返回 const 引用限制修改。不能推导跨动态库/进程唯一，也不解决退出时静态对象析构次序问题。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`e772946455b05194e74dcc3e56df5293a993393ac9ce5f0ef511e7664be0459e`。
