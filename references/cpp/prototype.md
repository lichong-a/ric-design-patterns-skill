...
[← C++ 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/cpp/prototype/main.cpp)
...
嵌套 vector/string 是值类型，编译器生成的复制会复制其内容。含 shared_ptr、资源句柄的对象不能据此推断深复制；多态原型另需 virtual clone 防切片。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`e3dd60d2dce29c65bd9bedd0c61314a8008ad25bb091abf2898f1882ae6047dd`。
