...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/iterator/main.swift)
...
Sequence/IteratorProtocol 是惯用入口；游标是可变值，两个 makeIterator 独立。一般 Sequence 不承诺多遍遍历；本 Bag 由 Array 提供这一额外性质。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`375866621e5c52af3cfd11c061fa0bf90fae2d36c80edeff9446396112d56dfd`。
