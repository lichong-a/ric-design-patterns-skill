...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/strategy/main.swift)
...
闭包是单操作策略的自然表达；存储回调需 @escaping，多任务使用则需重新设计 Sendable 与隔离。整数折扣只演示变化点，不作为真实账务实现。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`aa07522ceb32eec645f4e8a365f1878198bec73e2e8bf2a568530fdfde2788f3`。
