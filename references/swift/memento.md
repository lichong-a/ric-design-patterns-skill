...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/memento/main.swift)
...
String 值语义保存独立文本；快照强持身份令牌，避免单纯地址复用。fileprivate 对同文件代码不是秘密边界；拆分模块时应保留不透明公开 API。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`96aff856bb311621049f06eab902296894273a0877f28507af002868d6daac72`。
