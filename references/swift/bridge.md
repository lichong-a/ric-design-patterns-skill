...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/bridge/main.swift)
...
通知层次与 Channel 协议组合形成两个独立轴。值通道不需要 weak；只有实际的引用生命周期/环才需要弱引用设计。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`7058db4d43d75328f67f79965b311ac9d34b8d8bbab345f2365e5d8c93f6879e`。
