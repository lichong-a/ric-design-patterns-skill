...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/composite/main.swift)
...
协议 existential 集合统一叶子与组合；值 Bundle 使树成员列表复制明确。生产中仍需定义深度、引用子节点、累加溢出与图结构边界。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`1b3ac0d3a442f50e186b1dd5ed02e24ab944eaca9e8abf42ee42c0333d89aeaa`。
