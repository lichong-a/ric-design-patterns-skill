...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/command/main.swift)
...
引用接收者配合私有枚举明确生命周期；throws 报告顺序错误。命令保活接收者是此例的选择，不提供 UndoManager 集成或 actor 间事务撤销。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`b544c4ba11dada5d619f70fd47a9b92f59a2f9a65097bfcd3abbf95374474d55`。
