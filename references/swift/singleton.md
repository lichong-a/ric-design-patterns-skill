...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/singleton/main.swift)
...
static let 共享只读配置，final class 的不可变 Sendable 状态通过 Swift 6 检查。需要共享可变状态时优先考虑 actor 隔离，不要用 @unchecked Sendable 掩盖数据竞争。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`4b3155fd5a839851962157630f5ca7b1f849ea971658647abe53e6a94aea7998`。
