...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/observer/main.swift)
...
复制 Dictionary 值形成当前轮快照，不保证监听顺序。闭包强捕获引用可能形成 ARC 环；真实 UI 使用弱捕获或订阅生命周期对象，跨任务需隔离。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`0e475132b468e8a1648a6bf0ef385a2cf024f7aae6d99e4d4ec2e7fa98b32264`。
