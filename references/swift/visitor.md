...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/visitor/main.swift)
...
accept 调用类型明确的协议要求完成双分派；新增节点必须扩展所有访问者。enum 关联值加 switch 适合封闭数据模型，避免机械建立协议层。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`530f195772cc06720db1ac7482951d43721ed0f3bf1e41893d2d353ec5d92e28`。
