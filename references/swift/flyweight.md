...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/flyweight/main.swift)
...
class Style 明确演示共享身份，struct Glyph 保存外在值。池是单线程引用对象，不声明 Sendable；跨任务共享时应添加 actor 隔离或其他同步。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`cf772152741a232d8c78d0a279eaf6e7d131c36efe4b5e6794ad62eff3ff8a71`。
