# Swift · 模板方法（Template Method）

[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/template-method/main.swift)
...
final 固定流程，继承步骤因 Swift 无 abstract 使用显式失败占位契约。协议扩展中的方法要声明为协议要求才能获得预期动态分派，不能随意替换此结构。
...
```sh
cd examples/swift/template-method
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`5e9d3cab7fd84f72c8d38413884ad962429ed2be70e79976916f30cf0b8e76fc`。
