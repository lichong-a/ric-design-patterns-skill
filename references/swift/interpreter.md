# Swift · 解释器（Interpreter）

[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/interpreter/main.swift)
...
协议节点承载 AST，字典查询区分缺失值，加法显式检测溢出。没有词法/语法分析或执行沙箱；复杂封闭 AST 也可使用 indirect enum。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`bb6f0f71699a7d7de53f4c80ce970f6bd77ece50b6e101a9a2b083c35977784c`。
