...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/factory-method/main.swift)
...
Swift 无 abstract 类关键字，此继承教学版在基类扩展点显式失败，子类必须覆写。协议产品用 any existential；可考虑协议+默认流程避免可误实例化基类。
...
```sh
cd examples/swift/factory-method
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`7977b416e4cb42fe5dcb6ea47d1472b2a16d4bc8110b4505338c9aa92c342893`。
