...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/mediator/main.swift)
...
Dialog 拥有控件，闭包用 [weak self] 打破 ARC 强引用环；不用 unowned 假定中介者永远存活。真实 UI 常需 @MainActor，示例仅同步模型。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`69d36daa5301a037fd07eaf5f85a8124cc52c7ba849f0484cff1ad67c5582817`。
...
- [参考站语言示例抽样](https://refactoringguru.cn/design-patterns/mediator/swift/example)
