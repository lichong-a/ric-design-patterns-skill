...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/state/main.swift)
...
状态 struct 返回下一态，避免不必要的状态对象引用环。固定状态集合可用 enum+switch；模式选择取决于行为复杂度而非类数量。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`f939b859872a67d5351275a26c8213b6db45b2927ecf83e030082d44b719969e`。
