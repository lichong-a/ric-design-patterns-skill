...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/adapter/main.swift)
...
struct 组合旧 API 并满足新协议；显式 Double 转换保证单位语义。选择值/引用适配器应以原服务的身份和生命周期需求为依据。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`34304ab511f9812a914a96e8c93d6d2236f6bd27224620d7d18ab0596c10a3ec`。
