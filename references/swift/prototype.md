...
[← Swift 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/swift/prototype/main.swift)
...
String 和嵌套 Array 使用值语义，写时复制是实现优化而非共享可变值语义。原型意图可由值复制满足；class 图需要显式复制，不能机械套用此代码。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`8b2c8b64190473837f16336272c9716d68b7088ac468beaa2d63ef0b223daf62`。
