# JavaScript · 享元（Flyweight）

[← JavaScript 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/javascript/flyweight/main.mjs)
...
```sh
node examples/javascript/flyweight/main.mjs
```

期望标准输出：`OK flyweight`。任何内嵌断言失败都应导致非零退出；Python 不要使用 `-O` 禁用断言，Swift 不要使用 `-Ounchecked`。

**当前源码状态：已通过运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`95adbf3563398aa8d85acde87e453211f7c97081b928aae96354c04a4940b3f9`。
