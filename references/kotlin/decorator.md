...
[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/decorator/Main.kt)
...
by 自动转发未覆写成员，变化操作仍显式覆写。被委托对象内部对自身方法的调用不会自动转到包装器覆写版本，应避免把委托当继承。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`62a3e215fa2631647f9d3389dcd159b002c753c8684bc9682f8b5f2759136d70`。
