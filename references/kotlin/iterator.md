...
[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/iterator/Main.kt)
...
复用标准 Iterable/Iterator 即可参与 for、sum 等生态操作。Sequence 提供惰性处理，但惰性不自动意味着数据源可重复遍历或线程安全。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`33cd84c1bada173777f275ed57e9cf6cefa0771ebb37dacb08c5b90d62649580`。
