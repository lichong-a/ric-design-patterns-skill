...
[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/strategy/Main.kt)
...
函数类型适合单操作策略，多个相关操作/生命周期才考虑接口。这里用整数演示算法切换，不作为实际计费、币种精度或溢出方案。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`4eb8770e6e7658036661b9172b229ab5f9ec6ba3459d2f295c836c6d6c50b5af`。
