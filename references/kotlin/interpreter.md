# Kotlin · 解释器（Interpreter）

[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/interpreter/Main.kt)
...
数据类承载 AST，Map 明确环境，JVM Math.addExact 检查溢出。这是 JVM 示例；没有实现词法/语法分析，也不是允许执行任意脚本的沙箱。
...
```sh
cd examples/kotlin/interpreter
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`e2a6ba7d5309c2d0c947331e8fb315605d9ae6d1654d9ad4791fb1bd97265b65`。
