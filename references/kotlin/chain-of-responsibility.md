# Kotlin · 责任链（Chain of Responsibility）

[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/chain-of-responsibility/Main.kt)
...
可空后继与高阶函数表达验证链，&& 短路在先验失败时不执行下一节点。suspend/协程取消、重试与事务不是这个同步例子的保证。
...
```sh
cd examples/kotlin/chain-of-responsibility
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`538f3c316a237b83f6761c99a9f774e1f645fb90173eeeafd327bba24fc5570c`。
