...
[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/prototype/Main.kt)
...
data class 的 copy 默认是浅复制；这里显式复制两层可变集合。深复制是针对已知对象结构的策略，不是语言自动为任意图完成。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`e70931276e47255b9cd490c1699bc89cf143afa25c0486b7bb5b9733fb05dd86`。
