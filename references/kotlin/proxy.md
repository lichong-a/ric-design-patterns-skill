...
[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/proxy/Main.kt)
...
Kotlin/JVM 默认 lazy 使用同步初始化；这里的 loads 只在顺序测试中读取，不据此声称该计数器具有独立的跨线程安全 API。延迟属性是实现手段，统一 Image 接口才是代理结构。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`6169ffcd3d0c1bd00032559be16845487b42edf2e041522f5edfa85864acabbb`。
