...
[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/command/Main.kt)
...
用命令私有枚举约束生命周期；check 不依赖 JVM -ea。保存前值的撤销不支持交错写入，也不等同于持久化命令或事件溯源。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`f617ba3b3e5bb2cce77f473d3269b2b6036af55709516123e818bc196ccdd63b`。
