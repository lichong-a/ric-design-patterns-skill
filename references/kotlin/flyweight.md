...
[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/flyweight/Main.kt)
...
不可变字段的数据类适合内在状态；=== 验证共享身份而非 == 值相等。普通 MutableMap.getOrPut 不提供并发唯一创建保证，也不控制缓存大小。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`20f5d220bdafd9a3d9595c7e85903b67c38867a15b0121d4fe1292795ba36927`。
