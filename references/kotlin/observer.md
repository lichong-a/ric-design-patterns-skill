...
[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/observer/Main.kt)
...
订阅令牌加回调快照定义当前轮通知语义。同步例子不同于 Flow/SharedFlow，不提供协程背压、并发安全或异常隔离；监听者异常向上传播。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`d1ff4ce806ba475ce8b53c05050312005b8b6a8a3c619c81cdd280a788970e9d`。
