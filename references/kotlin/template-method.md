# Kotlin · 模板方法（Template Method）

[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/template-method/Main.kt)
...
run 默认 final，parse 是唯一受保护变化点。Locale.ROOT 固定示例大小写规则，不跟随运行机器的默认 Locale；依赖 JVM 标准库。
...
```sh
cd examples/kotlin/template-method
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`5713d098180e9a1f777f469e0519c1ad9e07d13c31ad7c71fffbed1c590d8d4d`。
