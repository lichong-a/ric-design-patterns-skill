# Kotlin · 生成器（建造者）（Builder）

[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/builder/Main.kt)
...
apply 支持链式配置，toList 创建与建造器隔离的快照。List 是只读接口不等于所有实现都深不可变；少量参数优先比较具名参数与默认值。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`92a49093d011d7f5f29608206d383a161f23dd73560e68fbec659e06ca569701`。
