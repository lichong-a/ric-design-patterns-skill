...
[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/state/Main.kt)
...
无状态的具体状态用 object 共享；客户特有数据必须留在 Gate，避免单例状态跨客户串值。状态有限且小，可比较 sealed class 加 when 的代数数据类型方案。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`a8483011ab57470e947401b48a984e9e79c67b6c082863d5393ac7e12ce1ff52`。
