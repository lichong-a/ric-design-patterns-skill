...
[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/adapter/Main.kt)
...
构造函数注入旧服务，对象适配器显式转换单位。接口委托 by 适合直接转发，但不能代替这里的语义转换。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`0cd89a40b69d175ed77f3c7e28365a542e847d1e7be69a6171ac7f6395ed2d30`。
