...
[← Kotlin 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/kotlin/memento/Main.kt)
...
通过公开标记接口与私有嵌套 Snapshot 实现不透明快照；=== 比较源发器令牌身份。类型封装不是针对反射/反序列化攻击的安全边界。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`32df9bc3671f30b0ec69c43760e59daecf97f035968f2305971e5fb10c0ebc1a`。
