...
[← Go 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/go/builder/main.go)
...
链式指针接收者修改建造器，Build 复制 slice 底层元素避免共享数组。成品依然可修改；小配置也应比较结构体字面量或函数选项。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`7c44e0fd7a924e55c446ec3faf2ee0c3b42432c21ccba8d0b8419861a75d8f7d`。
