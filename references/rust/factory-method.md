# Rust · 工厂方法（Factory Method）

[← Rust 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/rust/factory-method/main.rs)
...
trait 默认工作流调用可替换 make，Box<dyn Renderer> 转移产品所有权。这是无类继承语言的工厂方法意图移植；默认方法仍可覆写，不能宣称具有 final 约束。
...
```sh
cd examples/rust/factory-method
...
**当前源码状态：待验证（无匹配当前源码哈希的运行记录）。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`e1871b3feeac23eb7b09a0496a05be2b94a81682402519ce0ffa9c997e836db0`。
