...
[← Rust 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/rust/prototype/main.rs)
...
derive(Clone) 递归调用字段 Clone，这里的 String/Vec 复制拥有的数据。Rc/Arc 的 Clone 只增加共享引用，不能把 Clone 一概解释成深复制；Copy 则是另一种语义约束。
...
**当前源码状态：待验证（无匹配当前源码哈希的运行记录）。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`7fdba5ce2fa33310034726376743027bd31c0478e4c8f0c740f3de9a9b6f267a`。
