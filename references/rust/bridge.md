...
[← Rust 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/rust/bridge/main.rs)
...
通知轴和通道轴各用 trait 表达，不需要继承；Box<dyn Channel> 持有实现。泛型静态分派是替代绑定方式，应依据运行时替换需要选择。
...
**当前源码状态：待验证（无匹配当前源码哈希的运行记录）。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`0ca988f1adada7d1bcdf781f63c6421951b628bc4c823ccd3f751132ce745829`。
