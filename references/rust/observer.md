...
[← Rust 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/rust/observer/main.rs)
...
先克隆 Rc 回调列表，再把 &mut Events 传给回调允许自退订，避免同时持有容器迭代借用。RefCell 只用于测试收集，借用冲突会 panic；无线程安全或背压保证。
...
**当前源码状态：待验证（无匹配当前源码哈希的运行记录）。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`95c5b74f8a17c19559c82d4a04eb07b16542630bcc4ee19b7c41cc8dd9c5c3d4`。
