...
[← Rust 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/rust/decorator/main.rs)
...
拥有 inner 的 trait object 形成运行时包装链，Drop 自动递归释放。泛型包装器可静态分派；不要把 Rust attributes/proc macros 与 GoF 装饰对象混同。
...
**当前源码状态：待验证（无匹配当前源码哈希的运行记录）。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`1d71d1e104b682c66d4028daf809077dc46677b901d48fb2321a48bb0a551f76`。
