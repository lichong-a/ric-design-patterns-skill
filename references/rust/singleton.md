...
[← Rust 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/rust/singleton/main.rs)
...
OnceLock 自 Rust 1.70 可用，返回共享静态借用并同步初始化。示例字段只读；可变全局数据需要 Mutex/RwLock 等明确同步，不允许用 static mut 或 unsafe 绕过检查。
...
**当前源码状态：待验证（无匹配当前源码哈希的运行记录）。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`f3c03a9d4eb5cfd933085ac35c9c4fa54c6fdb9de0165d610f816a8c79f18313`。
