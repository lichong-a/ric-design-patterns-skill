...
[← Rust 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/rust/visitor/main.rs)
...
显式 accept 与具体 visit 方法双分派，借用节点避免复制。封闭节点集合可选 enum+match；trait object 路径更开放，但新增节点会扩展所有访问者契约。
...
**当前源码状态：待验证（无匹配当前源码哈希的运行记录）。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`0d516e23ec2a49271240a819ae3128f2808bbbd1bfac5fd4e6fbe404040adb2e`。
