...
[← Rust 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/rust/state/main.rs)
...
状态借用自身并返回拥有的下一态，Context 在计算结束后替换 Box，避免双重可变借用。小型封闭状态 enum 往往更简单，类型状态适合把合法转换提升为编译期约束。
...
**当前源码状态：待验证（无匹配当前源码哈希的运行记录）。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`a58b3349eb6197dfae50944ec2238a3b0e011792aa0009b997ff302090cf320f`。
