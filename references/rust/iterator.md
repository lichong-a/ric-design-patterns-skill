...
[← Rust 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/rust/iterator/main.rs)
...
为 &Bag 实现 IntoIterator 产生借用迭代器，生命周期约束防止容器释放后继续使用。消费式 into_iter、共享 iter 与可变 iter_mut 的所有权语义必须区分。
...
**当前源码状态：待验证（无匹配当前源码哈希的运行记录）。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`ac24787fe26701428ec19a63f5d45cf43b1e4882e290a7ade70c05351251978d`。
