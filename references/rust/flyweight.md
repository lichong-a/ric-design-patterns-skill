...
[← Rust 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/rust/flyweight/main.rs)
...
Rc 明确单线程共享，不实现 Send/Sync；私有字段与只读接口保留内在状态。跨线程应比较 Arc 加池同步，Arc 本身不使任意内部可变状态安全。
