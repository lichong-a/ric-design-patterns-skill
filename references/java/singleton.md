...
[← Java 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/java/singleton/Main.java)
...
enum 单例利用 JVM 类初始化语义，不手写双重检查锁。唯一性限定类加载器范围；初始化安全不代表新增可变字段自动线程安全。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`30ba1a0eb80d3b98a5848af95160aa9a63a2210e50e49f206cd211209929333c`。
