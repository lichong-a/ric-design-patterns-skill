...
[← Java 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/java/composite/Main.java)
...
record 与只读子节点列表组成树；stream 只是汇总方式，不替代 Component/Composite 结构。教学整数未覆盖大规模累计的溢出策略。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`64e35b0235d70ac1dc95e11af7d1f92e08150da780200b52f3cdc40f92389303`。
