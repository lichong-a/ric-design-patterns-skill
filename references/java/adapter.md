...
[← Java 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/java/adapter/Main.java)
...
使用对象组合而非继承旧类；构造时检查非空依赖。double 签名不表达单位，契约测试必须检验厘米到米的转换。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`1c1eb5b1ad0deda0ca36519791113bb0c6851901bdb5f6980bfbc7259ca54c51`。
