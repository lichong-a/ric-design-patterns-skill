# Java · 生成器（建造者）（Builder）

[← Java 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/java/builder/Main.java)
...
现代构建器变体；record 本身只提供浅层不可变字段，紧凑构造器用 List.copyOf 建立只读独立容器。若成员为可变对象仍需额外复制。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`8266984856e6ff8ad84558dcb14f61a7b6165867fe22d5347b4aba398484c5c1`。
