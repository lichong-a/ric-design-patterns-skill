...
[← Java 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/java/strategy/Main.java)
...
使用 JDK 函数式接口 IntUnaryOperator，减少无必要的策略类与装箱。纯函数与捕获可变状态的 lambda 具有不同线程安全条件。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`6e42ffe99a3db159077614fb5651a054aa1f62506b68fbaf1b2be5e138ed9705`。
