...
[← Java 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/java/facade/Main.java)
...
外观只编排用例并传播失败，不转变成服务定位器。本例子系统是内存模拟，真实事务边界不能由类名推导。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`ffa601a4d1b98a767c3e8370a3b05f7577046bc1c6972fbe7cf99ac7964fb6f4`。
