...
[← Java 选择指南](README.md) · [Skill 入口](../../SKILL.md) · [可运行源码](../../examples/java/prototype/Main.java)
...
显式 copy 契约复制两层容器，不依赖 Object.clone/Cloneable 的浅复制语义。不可变 String 可共享，资源对象不应按同样规则盲目复制。
...
**当前源码状态：已通过编译/运行与内嵌断言。** [完整验证记录](../../docs/VERIFICATION.md)。源码 SHA-256：`80e4e6692a04a3f35620efaa6c48c7949eb5ee0458fe5d010f16f71f36f4559c`。
